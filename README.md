...
| [Phase 4](phase-4/README.md) | Frameworks and patterns — Claude Agent SDK, the 5 BEA patterns, LangGraph | 🚧 in progress (5/9) |
...
└── phase-4/              # 🚧 in progress — frameworks and patterns
    ...
    ├── 04_prompt_chaining.py     # BEA pattern #1: draft → gate → translate (a workflow, plain anthropic)
    ├── 05_routing.py             # BEA pattern #2: classifier → specialized handler (cost/quality routing)
    └── reports/          #    generated reports (checked in as samples)
```
